...
public interface IView {
	...
	void showSelectedMember(String id, String name, String personal_number, Iterator<Boat> boats);
	...
	void showBoats(Iterator<Boat> boats);
	boolean showDeleteBoatConfirmation(String id);	// true = deletion , identifier boat?
